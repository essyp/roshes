...
<div id="content" class="ui-content ui-content-aside-overlay">
                ...
                <div class="ui-content-body">
                    ...
                    <div class="ui-container">
                        <div class="row">
                            <form id="status_form" action='{{url("admin/payment-gateway-status")}}' method="POST">
                                {{ csrf_field() }}
                            <div class="col-sm-12">
                            <div class="mbot-20">
                                    <div class="btn-group">
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#new" class="btn btn-default">Add New Gateway</button>
                                </div>
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <table id="datatable" class="table responsive-data-table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{asset('images/payments/'.$bl->logo)}}" style="max-height: 60px; max-width: 60px"></td>
                                                <td>{{$bl->name}}</td>
                                                <td>{{$bl->public_key}}</td>
                                                <td>{{$bl->secret_key}}</td>
                                                @if($bl->status==ACTIVE)
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="form">
                        ...
                        <div class="form-group">
                            <label for="public_key" class="control-label col-lg-3">Public Key</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="public_key" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="secret_key" class="control-label col-lg-3">Secret Key</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="secret_key" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="image" class="control-label col-lg-3">Logo</label>
                            <div class="col-lg-6">
...
<div  id="editmodal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Update Gateway</h4>
            </div>
            ...
            <div class="form">
                        ...
                        <div class="form-group">
                            <label for="public_key" class="control-label col-lg-3">Public Key</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editpublic_key" name="public_key" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="secret_key" class="control-label col-lg-3">Secret Key</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editsecret_key" name="secret_key" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="image" class="control-label col-lg-3">Logo</label>
...
$("#imgInp2").change(function() {
  ...
  $('#new-form').submit(function(e){
		...
		$.ajax({
			url: '{{url("admin/create-payment-gateway")}}',
			data: _data,
			...
			success: function(data){
				...
				if(data.status == "success"){
					...
					$( "#datatable" ).load( "{{url('/admin/payment-gateways')}} #datatable" );
                    close_loader('#page');
                    } else{
    ...
    function update(event){
           //$('#modaltitle').text("Update " +event.title)
            ...
            $('#editpublic_key').val(event.public_key)
            $('#editsecret_key').val(event.secret_key)
            $('#editid').val(event.id)
            $("#editimage").attr('src', "{{asset('images/payments')}}/"+event.logo)
        ...
        $('#edit-form').submit(function(e){
            ...
            var _data = new FormData(form);
            $.ajax({
                url: '{{url("admin/update-payment-gateway")}}',
                data: _data,
                enctype: 'multipart/form-data',
                processData: false,
                contentType:false,
