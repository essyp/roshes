...
<div id="content" class="ui-content ui-content-aside-overlay">
                ...
                <div class="ui-content-body">
                    ...
                    <div class="ui-container">
                        <div class="row">
                            <form id="status_form" action='{{url("admin/project-status")}}' method="POST">
                                {{ csrf_field() }}
                            <div class="col-sm-12">
                                <div class="mbot-20">
                                    <div class="btn-group">
                                    ...
                                    <ul role="menu" class="dropdown-menu">
                                        ...
                                        <li><button class="btn btn-default" name="submit" type="button" onclick="status_form('processed')">Completed</button></li>
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#new" class="btn btn-default">Add New Project</button>
                                </div>
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <table id="datatable" class="table responsive-data-table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{asset('images/projects/'.$bl->image)}}" style="max-height: 60px; max-width: 60px"></td>
                                                <td>{{$bl->title}}</td>
                                                <td>{{$bl->cat->name}}</td>
                                                <td>{{$bl->client}}</td>
                                                <td>{{$bl->location}}</td>
                                                <td>{{date("d-m-Y",strtotime($bl->project_date))}}</td>
                                                @if($bl->status==ACTIVE)
                                                <td><span class="label label-success">Active</span></td>
                                                @elseif($bl->status==PROCESSED)
        ...
        <div class="modal-content">
            ...
            <div class="form">
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Project Name</label>
                            <div class="col-lg-9">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="client" class="control-label col-lg-3">Client Name</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="client" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="location" class="control-label col-lg-3">Project Location</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="location" type="text"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="project_date" class="control-label col-lg-3">Project Date</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="project_date" type="date" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="image" class="control-label col-lg-3">Project Image</label>
                            <div class="col-lg-6">
        ...
        <div class="modal-content">
            ...
            <div class="form">
                        ...
                        <div class="form-group">
                            <label for="cat_id" class="control-label col-lg-3">Category</label>
                            <div class="col-lg-9">
                                <select class=" form-control" id="editcat_id" name="cat_id" required="required">
                                @foreach($category as $ch)
                                 <option value="{{$ch->id}}">{{$ch->name}}</option>
                                 @endforeach
                                </select>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="client" class="control-label col-lg-3">Client Name</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editclient" name="client" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="location" class="control-label col-lg-3">Project Location</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editlocation" name="location" type="text"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="project_date" class="control-label col-lg-3">Project Date</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editproject_date" name="project_date" type="date" />
                            </div>
                        </div>
                        <div class="form-group">
...
$('#new-form').submit(function(e){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data.status == "success"){
					...
					$( "#datatable" ).load( "{{url('/admin/projects')}} #datatable" );
                    close_loader('#page');
                    } else{
    ...
    function update(event){
        ...
        $('#editcat_id').val(event.cat_id)
        $('#editclient').val(event.client)
        $('#editlocation').val(event.location)
        $('#editproject_date').val(event.project_date)
        $('#editid').val(event.id)
        $("#editimage").attr('src', "{{asset('images/projects')}}/"+event.image)
