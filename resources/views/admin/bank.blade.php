...
<div id="content" class="ui-content ui-content-aside-overlay">
                ...
                <div class="ui-content-body">
                    ...
                    <div class="ui-container">
                        <div class="row">
                            <form id="status_form" action='{{url("admin/bank-status")}}' method="POST">
                                {{ csrf_field() }}
                            <div class="col-sm-12">
                            <div class="mbot-20">
                                    <div class="btn-group">
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#new" class="btn btn-default">Add New Bank</button>
                                </div>
                                <section class="panel">
        ...
        <div class="modal-content">
            ...
            <div class="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class=" form-control" name="bank_name" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="account_name" class="control-label col-lg-3">Account Name</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="account_name" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="account_no" class="control-label col-lg-3">Account No</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="account_no" type="text" required="required"/>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="form">
                       ...
                       <div class="form-group">
                            <label for="bank_name" class="control-label col-lg-3">Bank Name</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editbank_name" name="bank_name" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="account_name" class="control-label col-lg-3">Account Name</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editaccount_name" name="account_name" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="account_no" class="control-label col-lg-3">Account No</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editaccount_no" name="account_no" type="text" required="required"/>
                            </div>
                        </div>
  ...
  $('#new-form').submit(function(e){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data.status == "success"){
					...
					$( "#datatable" ).load( "{{url('/admin/banks')}} #datatable" );
                    close_loader('#page');
                    } else{
    ...
    function update(event){
           //$('#modaltitle').text("Update " +event.title)
            $('#editbank_name').val(event.bank_name)
            $('#editaccount_name').val(event.account_name)
            $('#editaccount_no').val(event.account_no)
            $('#editid').val(event.id)
