...
<div id="content" class="ui-content ui-content-aside-overlay">
                ...
                <div class="ui-content-body">
                    ...
                    <div class="ui-container">
                        <div class="row">
                            <form id="status_form" action='{{url("admin/service-status")}}' method="POST">
                                {{ csrf_field() }}
                            <div class="col-sm-12">
                                <div class="mbot-20">
                                    <div class="btn-group">
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#new" class="btn btn-default">Add New Service</button>
                                </div>
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <table id="datatable" class="table responsive-data-table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{asset('images/services/'.$bl->image)}}" style="max-height: 60px; max-width: 60px"></td>
                                                <td>{{$bl->title}}</td>
                                                @if($bl->status==ACTIVE)
        ...
        <div class="modal-content">
            ...
            <div class="form">
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Service Title</label>
                            <div class="col-lg-9">
...
$('#new-form').submit(function(e){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data.status == "success"){
					...
					$( "#datatable" ).load( "{{url('/admin/services')}} #datatable" );
                    close_loader('#page');
                    } else{
    ...
    function update(event){
        ...
        $('#editid').val(event.id)
        $("#editimage").attr('src', "{{asset('images/services')}}/"+event.image)
