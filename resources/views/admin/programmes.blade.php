...
<div id="content" class="ui-content ui-content-aside-overlay">
                ...
                <div class="ui-content-body">
                    ...
                    <div class="ui-container">
                        <div class="row">
                            <form id="status_form" action='{{url("admin/programme-status")}}' method="POST">
                            {{ csrf_field() }}
                            <div class="col-sm-12">
                            <div class="mbot-20">
                                    <div class="btn-group">
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#new" class="btn btn-default">Add New Programme</button>
                                </div>
                                <section class="panel">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Add New Programme</h4>
            </div>
            ...
            <div class="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class=" form-control" name="venue" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="week_day" class="control-label col-lg-3">Week Day</label>
                            <div class="col-lg-9">
                                <select class=" form-control" name="week_day" required="required">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class=" form-control" name="start_time" type="time" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="end_time" class="control-label col-lg-3">End Time</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="end_time" type="time" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
...
<div  id="editmodal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="modaltitle">Update Programme</h4>
            </div>
            ...
            <div class="form">
                        ...
                        <div class="form-group">
                            <label for="venue" class="control-label col-lg-3">Venue</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editvenue" name="venue" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="week_day" class="control-label col-lg-3">Week Day</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editday" name="week_day" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="start_time" class="control-label col-lg-3">Start Time</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editstart" name="start_time" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="end_time" class="control-label col-lg-3">End Time</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="editend" name="end_time" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="short_descrpt" class="control-label col-lg-3">Description</label>
...
$('#create-form').submit(function(e){
		...
		$.ajax({
			url: '{{url("admin/create-programme")}}',
			data: _data,
			...
			success: function(data){
				...
				if(data.status == "success"){
					...
					$( "#datatable" ).load( "{{url('/admin/programmes')}} #datatable" );
                    close_loader('#page');
                    } else{
    ...
    function status_form(value) {
        ...
        function update(event){
           //$('#modaltitle').text("Update " +event.title)
            ...
            $('#editday').val(event.week_day)
            $('#editstart').val(event.start_time)
            $('#editend').val(event.end_time)
        ...
        $('#edit-form').submit(function(e){
            ...
            var _data = new FormData(form);
            $.ajax({
                url: '{{url("admin/update-programme")}}',
                data: _data,
                enctype: 'multipart/form-data',
                processData: false,
                contentType:false,
