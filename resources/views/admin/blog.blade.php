                    ...
                    <form id="status_form" action='{{url("admin/blog-status")}}' method="POST">
                        ...
                        <div class="col-sm-12">
                            <div class="mbot-20">
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#blog" class="btn btn-default">Add New Blog Post</button>
                                </div>
                                <section class="panel">
        ...
        <div class="modal-content">
            ...
            <div class="form">
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Blog Post Title</label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group">
                            <label for="full_descrpt" class="control-label col-lg-3">Description</label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group">
                            <label for="image" class="control-label col-lg-3">Blog Post Image</label>
                            <div class="col-lg-6">
...
$('#blog-form').submit(function(e){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data.status == "success"){
                    ...
                    $( "#datatable" ).load( "{{url('/admin/blog')}} #datatable" );
    ...
    function update(event){
        ...
        $('#editid').val(event.id)
        $("#editimage").attr('src', "{{asset('images/blogs')}}/"+event.image)
