...
<div id="content" class="ui-content ui-content-aside-overlay">
                ...
                <div class="ui-content-body">
                    ...
                    <div class="ui-container">
                        <div class="row">
                            <form id="status_form" action='{{url("admin/product-category-status")}}' method="POST">
                                {{ csrf_field() }}
                            <div class="col-sm-12">
                            <div class="mbot-20">
                                    <div class="btn-group">
...
<script>
  $('#new-form').submit(function(e){
		...
		$.ajax({
			url: '{{url("admin/create-product-category")}}',
			data: _data,
			...
			success: function(data){
				...
				if(data.status == "success"){
					...
					$( "#datatable" ).load( "{{url('/admin/product-categories')}} #datatable" );
                    close_loader('#page');
                    } else{
    ...
    function update(event){
        ...
        $('#edit-form').submit(function(e){
            ...
            var _data = new FormData(form);
            $.ajax({
                url: '{{url("admin/update-product-category")}}',
                data: _data,
                enctype: 'multipart/form-data',
                processData: false,
                contentType:false,
